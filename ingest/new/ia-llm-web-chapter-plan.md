...
# Chapter Planning Document: The Information Architecture of the LLM Web
...
**Recommendation:** Option C - Place between current Chapters 10 and 11. IA serves as the bridge between "what technical patterns to use" (Chapter 10) and "how to design for both audiences" (Chapter 11).
...
**Purpose:** Establish that human-centred IA principles don't automatically translate to machine readability.
...
**Purpose:** Introduce a framework for thinking about IA at different scales.
...
1. **Validate positioning** - Confirm placement between Chapters 10 and 11
2. **Draft Section 1** - Establish the "why traditional IA falls short" foundation
3. **Create key diagrams** - Three-layer pyramid, URL structure diagram
4. **Review with existing content** - Ensure no duplication with Chapter 3, 10, 12
5. **Write sections progressively** - Following the outline above
6. **Integrate code samples** - From existing manifesto and planned.md content
7. **Cross-reference pass** - Add links to and from other chapters
8. **Technical review** - Validate against Web Audit Suite capabilities
9. **Style review** - Apply humanizer pass, check forbidden vocabulary
