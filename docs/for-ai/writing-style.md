...
3. **Update Glossary:** Always check and update `packages/manuscript/manuscript/Glossary.md` with any new terms discovered or definitions created during the process.
