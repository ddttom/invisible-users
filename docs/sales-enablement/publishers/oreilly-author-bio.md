...
**Key insight discovered:** The patterns that break AI agents also break humans. Semantic HTML, explicit state management, and structured data - solutions accessibility experts recommended for years - are now infrastructure requirements driven by commercial pressure.
...
- Migration strategies from legacy systems to modern platforms

### Adobe Edge Delivery Services (EDS) - Early Adoption
...
- Code examples included in book's technical chapters

### Agency and Consulting Work (2000-2015)
...
- Accessibility compliance across diverse user populations

### Early Career (1998-2000)

**E-commerce platform development** during the first dot-com era. Built shopping cart systems, payment integrations, and inventory management before these became standardised commodities. This historical perspective informs the book's analysis of infrastructure transitions.

## Industry Recognition

### Boye & Company - CMS Experts Group

Member of the CMS Experts Group, participating in strategic discussions about content management trends, technology evaluation, and digital experience best practices.

**January 21, 2026:** Presenting at Boye & Company members' call: "Websites That Work Perfectly - Until They Don't" - covering the invisible failure patterns documented in this book.
...
- **AI agent compatibility (LLM suitability analysis)**
...
- Development of detection and remediation strategies
- Validation through automated testing tools
...
- Continuous tracking of industry developments
...
- Industry analysis and trend evaluation

**Communication strength:** Ability to bridge technical detail with business context. The book demonstrates this by providing both strategic rationale (why this matters) and implementation patterns (how to do it) without losing either audience.
...
- Business case: competitive infrastructure vs optional enhancement

Audience: Enterprise digital experience decision-makers, content strategists, technical architects
...
- Accessibility and inclusive design events
...
- Technical depth accessible to business decision-makers
...
- Exclusivity (willing to commit exclusively to O'Reilly)
