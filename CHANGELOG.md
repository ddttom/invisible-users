...
## [2026-01-26 - Copyright and Attribution Protection]

### Added - Comprehensive Copyright and Attribution System

- **Business Strategy Documents** (main repository):
  - Created [docs/structure/copyright-and-attribution-templates.md](docs/structure/copyright-and-attribution-templates.md) - Standard copyright and attribution notices
  - Created [docs/structure/mx-gathering-monetization-strategy.md](docs/structure/mx-gathering-monetization-strategy.md) - Strategic monetization overview
  - Created [docs/structure/mx-gathering-business-plan-draft.md](docs/structure/mx-gathering-business-plan-draft.md) - Detailed business plan (Year 1: £211,750 revenue target)
  - Created [docs/structure/mx-gathering-intellectual-property-strategy.md](docs/structure/mx-gathering-intellectual-property-strategy.md) - Comprehensive IP protection (£4,000-£6,000 initial investment)

- **MX-Bible Submodule** (commit 63ab164):
  - Added copyright field to YAML frontmatter in all 15 chapter files
  - Updated ai-instruction field with copyright protection notice
  - Applies to: chapters 1-15, preface, executive summary, reading guide, rear cover, The-End

- **MX-Handbook Submodule** (commit 97e9ace):
  - Added copyright field to YAML frontmatter in all 12 chapter files
  - Updated ai-instruction field with copyright protection notice
  - Applies to: preface and chapters 1-11

- **Shared Appendices Submodule** (commit b018cb6):
  - Added copyright field to YAML frontmatter in all 15 appendix files (A-O)
  - Updated ai-instruction field with copyright protection notice
  - All appendices now include copyright metadata

- **MX-Gathering Submodule** (commit 35c87d9):
  - Added attribution metadata to README.md and llms.txt
  - Updated author identity to "Tom Cranstoun 'The MX Guy'" branding
  - Added MIT License with attribution requirement
  - Standard attribution: "Based on Machine Experience (MX) patterns by Tom Cranstoun 'The MX Guy'"

- **Outputs Submodule** (commit 780220a):
  - Cleaned up outputs directory structure
  - Removed draft blog files from top-level blogs directory
  - Removed obsolete draft markdown sources (45 files deleted)
  - Kept published HTML blogs and generated PDFs

- **Main Repository Documentation**:
  - Updated [README.md](README.md) with copyright and attribution section
  - Updated [llms.txt](llms.txt) with copyright metadata and "The MX Guy" branding
  - Updated submodule pointers to reflect all copyright commits

### Fixed - Markdown Linting

- Fixed YAML frontmatter placement (must be at line 0, before H1 heading)
- Converted emphasis-as-heading to proper H4 headings in IP strategy document
- Added blank lines around lists for MD032 compliance
- Wrapped bare URLs in angle brackets for MD034 compliance
- All business planning documents now pass markdown linting

### Copyright Protection Structure

**Private Materials (Copyright © 2026 Tom Cranstoun. All rights reserved.):**

- Book manuscripts: MX-Bible, MX-Handbook, Shared Appendices (42 files)
- Business strategy documents (3 files)
- Outputs submodule (all generated content)

**Public Materials (Attribution Required):**

- MX-Gathering: MIT License with attribution "Concepts by Tom Cranstoun 'The MX Guy'"
- Web Audit Suite: MIT License with attribution
- Main repository documentation: Attribution required

### Monetization Strategy Summary

**Professional Certification Programme:**

- Three tiers: Foundation (£199), Implementation Specialist (£349), Advanced Architect (£499)
- Target: 500 certifications Year 1

**Book Subscription Service:**

- Individual (£120/year), Team (£450/year), Enterprise (£2,500+/year)
- Yearly print copy + quarterly digital updates
- Target: 200 subscribers Year 1

**Financial Projections:**

- Year 1 Revenue: £211,750 (certification £137k, corporate training £22.5k, subscriptions £37k, consulting £15k)
- Year 1 Profit: £60,750
- Year 3 Profit: £240,000

**Intellectual Property Investment:**

- Initial: £4,000-£6,000 (company registration, UK trademarks, legal agreements)
- Annual maintenance: £3,750 (insurance, monitoring, legal review)
- International expansion (Year 2): £3,600 (EU/US trademarks, US copyright)

### Rationale

Copyright and attribution protection provides legal foundation for monetization whilst preserving open source community values. The strategy balances commercial protection (book manuscripts, business documents) with community access (MX-Gathering patterns, code examples). Author branding as "The MX Guy" creates memorable identity for professional certification and thought leadership positioning.

## [2026-01-26 - Blog Workflow Documentation]

### Added - Appendix P: Blog Generation Workflow

- **Shared Appendices Submodule** (commit dfd8f68):
  - Created comprehensive Appendix P documenting metadata-driven blog workflow
  - Complete documentation (~1,016 lines) covering:
    - Metadata schema design (YAML frontmatter for markdown, HTML meta tags, CSS headers)
    - State tracking system with four lifecycle states (draft, in-review, published, archived)
    - File organization patterns separating drafts from generated content
    - Generation workflow using scripts/generate-blog-html.js
    - WCAG 2.1 AA compliance requirements (contrast ratios, semantic HTML, validation)
    - State transition rules and validation processes
  - Demonstrates Machine Experience principles in practice:
    - Metadata as first-class content (not optional decoration)
    - Explicit state tracking through all lifecycle stages
    - AI-friendly HTML with Schema.org structured data
    - Semantic structure serving humans, AI agents, and build tools
  - All markdown linting passed after auto-fix (MD031, MD032 errors corrected)

- **Bible Submodule** (commit 4657e46):
  - Added cross-reference to Appendix P in Chapter 12 (Technical Advice)
  - Cross-reference appears in "Additional Reference Material" section
  - Description highlights practical MX principles demonstration

- **Main Repository** (commit 6c32729):
  - Updated [docs/structure/todo.txt](docs/structure/todo.txt) to mark "Blog Workflow Documentation" task complete
  - Updated submodule pointers to new commits

### Rationale

Blog generation workflow provides a complete, production-tested example of how explicit metadata, state machines, and validation gates create content that works for multiple audiences simultaneously (content creators, AI agents, search engines, build tools). This fills a gap in the book by showing MX principles applied to a real workflow rather than just theoretical patterns.

## [2026-01-26 - SVG Text Corrections and Validation Workflow]

### Fixed - Bible SVG Text Content

- **Bible Submodule** (commit 347320f):
  - Fixed SVG text content for writing style guide compliance
  - Removed "The" prefix from 9 diagram headings per Section 6 (concise, business-like tone):
    - chapter-02-illustration.svg: "Anatomy of Invisible Failure"
    - chapter-03-illustration.svg: "Architectural Conflict"
    - chapter-04-illustration.svg: "Business Model Collision"
    - chapter-05-illustration.svg: "Value Extraction Problem"
    - chapter-06-security-maze.svg: "Security Maze - Two Different Problems"
    - chapter-07-legal-landscape.svg: "Legal Landscape - Who's Liable?"
    - chapter-08-human-cost.svg: "Human Cost - Who Gets Left Behind"
    - chapter-11-what-agent-creators-must-build.svg: "Validation Pipeline"
    - chapter-15-three-layer-ia-pyramid.svg: "Three-Layer IA Framework"
  - Replaced Unicode "≠" with ASCII "!=" in chapter-03-illustration.svg for PDF generation compatibility (Section 8)
  - Fixed XML entity errors: & → &amp; in chapter-15-sitemap-as-toc.svg and chapter-15-url-structure-comparison.svg
  - All 11 modified SVG files pass xmllint validation
  - Preserved "The Convergence Principle" as exception (named concept used throughout book)

### Added - SVG/XML Validation Workflow

- **Main Repository** (commit d4c45f9):
  - Added xmllint validation steps to three skills that perform validation:
    - `.claude/skills/audit-site/skill.md`: Step 11 (Verify and Lint) now includes SVG/XML validation
    - `.claude/skills/md-workflow/skill.md`: New "Validating SVG/XML Files" subsection after markdown linting
    - `.claude/skills/create-blog/skill.md`: Validation section step 6 for extracted SVG files
  - Each skill includes:
    - xmllint validation commands for SVG/XML files
    - Common XML error patterns (unencoded &, <, >)
    - Fix examples for entity encoding issues
    - Positioned after markdown linting per workflow requirements

### Changed - Project Tracking

- **Main Repository** (commit 2206e59):
  - Updated `docs/structure/todo.txt` with SVG correction completion
  - Documented SVG text review and corrections (26/Jan/2026)
  - All 11 SVG files corrected for style guide compliance
  - Heading "The" prefix removed from 9 diagrams
  - Unicode special character replaced with ASCII equivalent
  - All files pass XML validation

### Fixed - Submodule Pointers (SVG Corrections)

- **Main Repository** (commit 8af414d):
  - Updated bible submodule pointer to 347320f (SVG text corrections)
