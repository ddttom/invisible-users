...
- **packages/manuscript/the-bible-of-mx/web/news.html:**
...
- **packages/manuscript/the-bible-of-mx/talks/members-call/talk.md:**
...
- **packages/manuscript/the-bible-of-mx/talks/members-call/talk-slides.js:**
...
- **packages/manuscript/the-bible-of-mx/code-examples/identity-delegation-README.md:**
...
- **packages/manuscript/the-bible-of-mx/code-examples/identity-delegation-worker.js:**
...
Eliminated `packages/project-web/` directory containing duplicate/stale copies of web files. All web files now live in single location: `packages/manuscript/the-bible-of-mx/web/`.
...
All web files now in `packages/manuscript/the-bible-of-mx/web/`:
...
**Submodule Changes (packages/manuscript/the-bible-of-mx/):**
...
- **Generated files**: appendix generation now correctly finds and copies news.html from packages/project-web/ to packages/manuscript/the-bible-of-mx/web/

### Fixed - PDF Generation (2026-01-12)

**Resolved XeLaTeX warnings for emoji characters:**

- **packages/manuscript/the-bible-of-mx/preface.md**: Replaced star emoji (⭐⭐⭐⭐) with text-based rating (4/5 Stars)
...
Fixed all remaining `invisible-users/manuscript` path references to use new `packages/manuscript/the-bible-of-mx` structure:
...
- Manuscript submodule now at `packages/manuscript/the-bible-of-mx/`
...
- Manuscript submodule path: `invisible-users/manuscript/` → `packages/manuscript/the-bible-of-mx/`
...
- Updated [web/site/event.html](packages/manuscript/the-bible-of-mx/web/site/event.html) with real Boye & Company webinar details
