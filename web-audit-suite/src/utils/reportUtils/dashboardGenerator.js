 ...
 */
export async function generateDashboard(results, outputDir, context, comparison = null, trendData = null) {
  try {
...
<body>
  <div class="container">
    ...
    ${buildDetailedMetricsSection(results, context)}
 ...
 */
function buildDetailedMetricsSection(results, context) {
  return `
