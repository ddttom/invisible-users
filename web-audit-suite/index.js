...
import { runBulkAudit } from './src/bulk-audit.js';
...
program
  ...
  .option(
    '--bulk <file>',
    'CSV file containing list of domains to audit',
  )
  .option('--agency-logo <path>', 'Path or URL to agency logo for white-labeling')
  .option('--agency-name <string>', 'Agency name for white-labeling')
  .parse(process.argv);
