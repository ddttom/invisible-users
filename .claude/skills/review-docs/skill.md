...
The writing style guide ([docs/for-ai/writing-style.md](docs/for-ai/writing-style.md)) defines standards for "The Invisible Users" book manuscript. The guide applies to all content in `packages/manuscript/manuscript/` but can be used to review any document.
