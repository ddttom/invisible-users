...
**Important**: Remember to perform linting and update [README.md](/README.md) ("The Invisible Users" at <https://github.com/ddttom/invisible-users/blob/main/README.md>), [CLAUDE.md](/CLAUDE.md) ("CLAUDE.md" at <https://github.com/ddttom/invisible-users/blob/main/CLAUDE.md>), and relevant documentation in `/docs` to reflect any significant changes made to this standards document before committing to version control.
