...
- **Default**: `5`
- **Usage**: `RATE_LIMIT_TOKENS=1 npm start`
...
- **Usage**: `RATE_LIMIT_INTERVAL=second npm start`

### Processing Options

#### `LIMIT`

Limit number of URLs to test (legacy).

- **Default**: `-1`
- **Usage**: `LIMIT=20 npm start`
...
- **Default**: `false`
- **Usage**: `INCLUDE_ALL_LANGUAGES=true npm start`

#### `NO_RECURSIVE`

Disable recursive crawling.

- **Default**: `false` (recursive enabled)
- **Usage**: `NO_RECURSIVE=true npm start`
...
- **Default**: `false`
- **Usage**: `CACHE_ONLY=true npm start`
...
- **Default**: `false`
- **Usage**: `NO_CACHE=true npm start`

#### `FORCE_DELETE_CACHE`

Force delete cache before starting.

- **Default**: `false`
- **Usage**: `FORCE_DELETE_CACHE=true npm start`
...
- **Default**: `false`
- **Usage**: `ENABLE_HISTORY=true npm start`
...
- **Default**: `false`
- **Usage**: `GENERATE_DASHBOARD=true npm start`
...
- **Default**: `false`
- **Usage**: `GENERATE_EXECUTIVE_SUMMARY=true npm start`

#### `NO_PUPPETEER`

Disable Puppeteer (headless browser).

- **Default**: `false`
- **Usage**: `NO_PUPPETEER=true npm start`

#### `THRESHOLDS_FILE`

Path to custom thresholds file.

- **Usage**: `THRESHOLDS_FILE=./custom-thresholds.json npm start`
...
For comprehensive CI/CD integration documentation, see [CI/CD Integration Guide](CI-CD-INTEGRATION.md) ("CI/CD Integration Guide" at <https://github.com/ddttom/invisible-users/blob/main/packages/web-audit-suite/docs/CI-CD-INTEGRATION.md>) ("CI/CD Integration Guide" at <https://github.com/ddttom/invisible-users/blob/main/packages/web-audit-suite/docs/CI-CD-INTEGRATION.md>) ("CI/CD Integration Guide" at <https://github.com/ddttom/invisible-users/blob/main/packages/web-audit-suite/docs/CI-CD-INTEGRATION.md>) ("CI/CD Integration Guide" at <https://github.com/ddttom/invisible-users/blob/main/packages/web-audit-suite/docs/CI-CD-INTEGRATION.md>) ("CI/CD Integration Guide" at <https://github.com/ddttom/invisible-users/blob/main/packages/web-audit-suite/docs/CI-CD-INTEGRATION.md>) ("CI/CD Integration Guide" at <https://github.com/ddttom/invisible-users/blob/main/packages/web-audit-suite/docs/CI-CD-INTEGRATION.md>).
